...
module HsToRocq.ConvertHaskell.Declarations.TypeSynonym (SynBody(..), convertSynDecl) where
...
import HsToRocq.Rocq.Gallina.Util (pattern Var, appList, binderIdents)
