...
module HsToRocq.Edits.ParserState where
...
import HsToRocq.Rocq.Gallina (ModuleIdent, AccessIdent, Ident, Qualid(..))
import HsToRocq.Rocq.Gallina.Util (identToQualid)
import HsToRocq.Edits.Lexer (Lexer, runLexer)
