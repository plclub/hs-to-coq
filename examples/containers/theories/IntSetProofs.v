...
Proof.
  ...
  match rhs with context[ HsToRocq.Wf.wfFix2 _ _ _ ?f ] => exact f end.
Defined.
...
Proof.
  intros.
  unfold foldrBits.
  rewrite HsToRocq.Wf.wfFix2_eq at 1.
  unfold foldrBits_go.
...
Proof.
  ...
  match rhs with context[ HsToRocq.Wf.wfFix2 _ _ _ ?f ] => exact (f bm x) end.
Defined.
...
Proof.
  ...
  reflexivity.
Qed.
#[export] Hint Resolve isBitMask_filterBits : isBitMask.
