...
#[local] Definition Eq___ExceptT_op_zeze__ {inst_e : Type} {inst_m
   : Type -> Type} {inst_a : Type} `{GHC.Base.Eq_ inst_e}
  `{Data.Functor.Classes.Eq1 inst_m} `{GHC.Base.Eq_ inst_a}
   : ExceptT inst_e inst_m inst_a -> ExceptT inst_e inst_m inst_a -> bool :=
  Data.Functor.Classes.eq1.

#[local] Definition Eq___ExceptT_op_zsze__ {inst_e : Type} {inst_m
   : Type -> Type} {inst_a : Type} `{GHC.Base.Eq_ inst_e}
  `{Data.Functor.Classes.Eq1 inst_m} `{GHC.Base.Eq_ inst_a}
   : ExceptT inst_e inst_m inst_a -> ExceptT inst_e inst_m inst_a -> bool :=
...
#[local] Definition Ord__ExceptT_op_zlze__ {inst_e : Type} {inst_m
   : Type -> Type} {inst_a : Type} `{GHC.Base.Ord inst_e}
...
#[local] Definition Ord__ExceptT_op_zgze__ {inst_e : Type} {inst_m
   : Type -> Type} {inst_a : Type} `{GHC.Base.Ord inst_e}
  `{Data.Functor.Classes.Ord1 inst_m} `{GHC.Base.Ord inst_a}
   : ExceptT inst_e inst_m inst_a -> ExceptT inst_e inst_m inst_a -> bool :=
  fun x y => Ord__ExceptT_compare x y GHC.Base./= Lt.
...
#[global] Definition runExceptT {e : Type} {m : Type -> Type} {a : Type}
   : ExceptT e m a -> m (Data.Either.Either e a) :=
  fun '(Mk_ExceptT m) => m.

#[local] Definition Functor__ExceptT_fmap {inst_m : Type -> Type} {inst_e
...
#[local] Definition Foldable__ExceptT_fold {inst_f : Type -> Type} {inst_e
   : Type} `{(Data.Foldable.Foldable inst_f)}
   : forall {m : Type},
...
#[local] Definition Foldable__ExceptT_foldl' {inst_f : Type -> Type} {inst_e
  ...
  fun {b : Type} {a : Type} =>
    fun f z0 =>
      fun xs =>
        Foldable__ExceptT_foldr (fun arg_0__ arg_1__ =>
                                   match arg_0__, arg_1__ with
...
#[local] Definition Foldable__ExceptT_foldMap' {inst_f : Type -> Type} {inst_e
  ...
  fun {m : Type} {a : Type} `{GHC.Base.Monoid m} =>
    fun f =>
      Foldable__ExceptT_foldl' (fun acc a => acc GHC.Base.<<>> f a) GHC.Base.mempty.
...
#[local] Definition Foldable__ExceptT_null {inst_f : Type -> Type} {inst_e
   : Type} `{(Data.Foldable.Foldable inst_f)}
...
#[local] Definition Foldable__ExceptT_sum {inst_f : Type -> Type} {inst_e
   : Type} `{(Data.Foldable.Foldable inst_f)}
   : forall {a : Type}, forall `{GHC.Num.Num a}, ExceptT inst_e inst_f a -> a :=
  fun {a : Type} `{GHC.Num.Num a} =>
...
#[local] Definition Traversable__ExceptT_traverse {inst_f : Type -> Type}
  ...
  fun {f : Type -> Type} {a : Type} {b : Type} `{GHC.Base.Applicative f} =>
    fun arg_0__ arg_1__ =>
      match arg_0__, arg_1__ with
      | f, Mk_ExceptT a =>
          Data.Functor.op_zlzdzg__ Mk_ExceptT (Data.Traversable.traverse
                                    (Data.Either.either (GHC.Base.pure GHC.Base.∘ Data.Either.Left) (GHC.Base.fmap
                                                                                                     Data.Either.Right
                                                                                                     GHC.Base.∘
                                                                                                     f)) a)
      end.
...
#[local] Definition Traversable__ExceptT_sequenceA {inst_f : Type -> Type}
  {inst_e : Type} `{(Data.Traversable.Traversable inst_f)}
   : forall {f : Type -> Type},
     forall {a : Type},
     forall `{GHC.Base.Applicative f},
...
#[local] Definition Traversable__ExceptT_sequence {inst_f : Type -> Type}
  {inst_e : Type} `{(Data.Traversable.Traversable inst_f)}
   : forall {m : Type -> Type},
     forall {a : Type},
     forall `{GHC.Base.Monad m},
...
#[global] Definition Applicative__ExceptT_op_ztzg__ {inst_m} {inst_s} `{_
...
#[global] Definition Monad__ExceptT_op_zgzgze__ {inst_m} {inst_e} `{_
   : GHC.Base.Monad inst_m}
   : forall {a} {b},
...
#[local] Definition Monad__ExceptT_return_ {inst_m : Type -> Type} {inst_e
   : Type} `{(GHC.Base.Monad inst_m)}
   : forall {a : Type}, a -> ExceptT inst_e inst_m a :=
...
(* Skipping all instances of class `GHC.Internal.Control.Monad.Fix.MonadFix',
   including `Control.Monad.Trans.Except.MonadFix__ExceptT' *)
...
(* Skipping all instances of class `Data.Functor.Contravariant.Contravariant',
   including `Control.Monad.Trans.Except.Contravariant__ExceptT' *)

#[global] Definition except {m : Type -> Type} {e : Type} {a : Type}
  `{GHC.Base.Monad m}
   : Data.Either.Either e a -> ExceptT e m a :=
  fun m => Mk_ExceptT (GHC.Base.return_ m).

#[global] Definition runExcept {e : Type} {a : Type}
   : Except e a -> Data.Either.Either e a :=
  fun '(Mk_ExceptT m) => Data.Functor.Identity.runIdentity m.

#[global] Definition mapExceptT {m : Type -> Type} {e : Type} {a : Type} {n
   : Type -> Type} {e' : Type} {b : Type}
   : (m (Data.Either.Either e a) -> n (Data.Either.Either e' b)) ->
     ExceptT e m a -> ExceptT e' n b :=
  fun f m => Mk_ExceptT (f (runExceptT m)).

#[global] Definition mapExcept {e : Type} {a : Type} {e' : Type} {b : Type}
...
#[global] Definition withExceptT {m : Type -> Type} {e : Type} {e' : Type} {a
...
#[global] Definition withExcept {e : Type} {e' : Type} {a : Type}
   : (e -> e') -> Except e a -> Except e' a :=
  withExceptT.

#[global] Definition throwE {m : Type -> Type} {e : Type} {a : Type}
  `{GHC.Base.Monad m}
   : e -> ExceptT e m a :=
  Mk_ExceptT GHC.Base.∘ (GHC.Base.return_ GHC.Base.∘ Data.Either.Left).

#[global] Definition catchE {m : Type -> Type} {e : Type} {a : Type} {e' : Type}
  `{GHC.Base.Monad m}
...
#[global] Definition handleE {m : Type -> Type} {e : Type} {e' : Type} {a
   : Type} `{GHC.Base.Monad m}
   : (e -> ExceptT e' m a) -> ExceptT e m a -> ExceptT e' m a :=
  GHC.Base.flip catchE.

#[global] Definition tryE {m : Type -> Type} {e : Type} {a : Type}
  `{GHC.Base.Monad m}
   : ExceptT e m a -> ExceptT e m (Data.Either.Either e a) :=
  fun m =>
    catchE (GHC.Base.liftM Data.Either.Right m) (GHC.Base.return_ GHC.Base.∘
                                                 Data.Either.Left).

#[global] Definition finallyE {m : Type -> Type} {e : Type} {a : Type}
  `{GHC.Base.Monad m}
   : ExceptT e m a -> ExceptT e m unit -> ExceptT e m a :=
  fun m closer =>
    tryE m GHC.Base.>>=
    (fun res => closer GHC.Base.>> Data.Either.either throwE GHC.Base.return_ res).

#[global] Definition liftCallCC {m : Type -> Type} {e : Type} {a : Type} {b
   : Type}
...
#[global] Definition liftListen {m : Type -> Type} {w : Type} {e : Type} {a
   : Type} `{GHC.Base.Monad m}
...
#[global] Definition liftPass {m : Type -> Type} {w : Type} {e : Type} {a
   : Type} `{GHC.Base.Monad m}
...
(* External variables:
     Gt Lt Type bool comparison false list negb pair true unit
     ...
     GHC.Base.op_zlze____ GHC.Base.op_zlzlzgzg__ GHC.Base.op_zlztzg____
     GHC.Base.op_zsze__ GHC.Base.op_zsze____ GHC.Base.op_ztzg____ GHC.Base.pure
     GHC.Base.pure__ GHC.Base.return_ GHC.Base.return___ GHC.Num.Int GHC.Num.Num
