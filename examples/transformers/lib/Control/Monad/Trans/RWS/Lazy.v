...
#[global] Definition RWS r w s :=
  (RWST r w s Data.Functor.Identity.Identity)%type.

Arguments Mk_RWST {_} {_} {_} {_} {_} _.

#[global] Definition runRWST {r} {w} {s} {m} {a} (arg_0__ : RWST r w s m a) :=
...
#[local] Definition Functor__RWST_op_zlzd__ {inst_m : Type -> Type} {inst_r
   : Type} {inst_w : Type} {inst_s : Type} `{(GHC.Base.Functor inst_m)}
   : forall {a : Type},
     forall {b : Type},
...
#[local] Definition Applicative__RWST_op_ztzg__ {inst_w : Type} {inst_m
  ...
  fun {a : Type} {b : Type} =>
    fun a1 a2 =>
      Applicative__RWST_op_zlztzg__ (GHC.Base.op_zlzd__ GHC.Base.id a1) a2.

#[local] Definition Applicative__RWST_pure {inst_w : Type} {inst_m
   : Type -> Type} {inst_r : Type} {inst_s : Type} `{GHC.Base.Monoid inst_w}
  `{GHC.Base.Functor inst_m} `{GHC.Base.Monad inst_m}
...
#[global] Definition Monad__RWST_op_zgzgze__ {inst_w} {inst_m} {inst_r} {inst_s}
...
#[local] Definition Monad__RWST_op_zgzg__ {inst_w : Type} {inst_m
   : Type -> Type} {inst_r : Type} {inst_s : Type} `{GHC.Base.Monoid inst_w}
...
(* Skipping all instances of class `GHC.Internal.Control.Monad.Fix.MonadFix',
   including `Control.Monad.Trans.RWS.Lazy.MonadFix__RWST' *)
...
#[global] Definition withRWST {r' : Type} {s : Type} {r : Type} {w : Type} {m
   : Type -> Type} {a : Type}
   : (r' -> s -> (r * s)%type) -> RWST r w s m a -> RWST r' w s m a :=
  fun f m => Mk_RWST (fun r s => Data.Tuple.uncurry (runRWST m) (f r s)).

#[global] Definition withRWS {r' : Type} {s : Type} {r : Type} {w : Type} {a
   : Type}
   : (r' -> s -> (r * s)%type) -> RWS r w s a -> RWS r' w s a :=
  withRWST.

#[global] Definition evalRWST {m : Type -> Type} {r : Type} {w : Type} {s
...
#[global] Definition execRWST {m : Type -> Type} {r : Type} {w : Type} {s
   : Type} {a : Type} `{GHC.Base.Monad m}
...
#[global] Definition asks {w : Type} {m : Type -> Type} {r : Type} {a : Type} {s
   : Type} `{GHC.Base.Monoid w} `{GHC.Base.Monad m}
   : (r -> a) -> RWST r w s m a :=
  fun f =>
    Mk_RWST (fun r s => GHC.Base.return_ (pair (pair (f r) s) GHC.Base.mempty)).

#[global] Definition reader {w : Type} {m : Type -> Type} {r : Type} {a : Type}
  {s : Type} `{GHC.Base.Monoid w} `{GHC.Base.Monad m}
   : (r -> a) -> RWST r w s m a :=
  asks.

#[global] Definition ask {w : Type} {m : Type -> Type} {r : Type} {s : Type}
  `{GHC.Base.Monoid w} `{GHC.Base.Monad m}
   : RWST r w s m r :=
  Mk_RWST (fun r s => GHC.Base.return_ (pair (pair r s) GHC.Base.mempty)).

#[global] Definition local {r : Type} {w : Type} {s : Type} {m : Type -> Type}
  {a : Type}
   : (r -> r) -> RWST r w s m a -> RWST r w s m a :=
  fun f m => Mk_RWST (fun r s => runRWST m (f r) s).

#[global] Definition writer {m : Type -> Type} {a : Type} {w : Type} {r : Type}
  {s : Type} `{GHC.Base.Monad m}
...
#[global] Definition tell {m : Type -> Type} {w : Type} {r : Type} {s : Type}
  `{GHC.Base.Monad m}
   : w -> RWST r w s m unit :=
  fun w =>
    Mk_RWST (fun arg_0__ arg_1__ =>
...
#[global] Definition listen {m : Type -> Type} {r : Type} {w : Type} {s : Type}
  {a : Type} `{GHC.Base.Monad m}
...
#[global] Definition listens {m : Type -> Type} {w : Type} {b : Type} {r : Type}
  {s : Type} {a : Type} `{GHC.Base.Monad m}
...
#[global] Definition pass {m : Type -> Type} {r : Type} {w : Type} {s : Type} {a
...
#[global] Definition censor {m : Type -> Type} {w : Type} {r : Type} {s : Type}
  {a : Type} `{GHC.Base.Monad m}
...
#[global] Definition state {w : Type} {m : Type -> Type} {s : Type} {a : Type}
  {r : Type} `{GHC.Base.Monoid w} `{GHC.Base.Monad m}
...
#[global] Definition get {w : Type} {m : Type -> Type} {r : Type} {s : Type}
  `{GHC.Base.Monoid w} `{GHC.Base.Monad m}
   : RWST r w s m s :=
  Mk_RWST (fun arg_0__ arg_1__ =>
             match arg_0__, arg_1__ with
...
#[global] Definition put {w : Type} {m : Type -> Type} {s : Type} {r : Type}
  `{GHC.Base.Monoid w} `{GHC.Base.Monad m}
   : s -> RWST r w s m unit :=
  fun s =>
    Mk_RWST (fun arg_0__ arg_1__ =>
...
#[global] Definition modify {w : Type} {m : Type -> Type} {s : Type} {r : Type}
  `{GHC.Base.Monoid w} `{GHC.Base.Monad m}
...
#[global] Definition gets {w : Type} {m : Type -> Type} {s : Type} {a : Type} {r
   : Type} `{GHC.Base.Monoid w} `{GHC.Base.Monad m}
   : (s -> a) -> RWST r w s m a :=
  fun f =>
    Mk_RWST (fun arg_0__ arg_1__ =>
...
#[global] Definition liftCallCC {w : Type} {m : Type -> Type} {a : Type} {s
   : Type} {b : Type} {r : Type} `{GHC.Base.Monoid w}
