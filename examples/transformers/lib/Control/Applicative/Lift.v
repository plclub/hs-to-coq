...
#[local] Definition Functor__Lift_fmap {inst_f : Type -> Type}
...
#[local] Definition Foldable__Lift_foldl' {inst_f : Type -> Type}
  ...
  fun {b : Type} {a : Type} =>
    fun f z0 =>
      fun xs =>
        Foldable__Lift_foldr (fun arg_0__ arg_1__ =>
                                match arg_0__, arg_1__ with
...
#[local] Definition Foldable__Lift_foldMap' {inst_f : Type -> Type}
  ...
  fun {m : Type} {a : Type} `{GHC.Base.Monoid m} =>
    fun f =>
      Foldable__Lift_foldl' (fun acc a => acc GHC.Base.<<>> f a) GHC.Base.mempty.
...
#[local] Definition Foldable__Lift_sum {inst_f : Type -> Type}
  ...
  fun {a : Type} `{GHC.Num.Num a} =>
    Coq.Program.Basics.compose Data.SemigroupInternal.getSum
                               (Foldable__Lift_foldMap' Data.SemigroupInternal.Mk_Sum).
...
#[local] Definition Traversable__Lift_traverse {inst_f : Type -> Type}
  ...
  fun {f : Type -> Type} {a : Type} {b : Type} `{GHC.Base.Applicative f} =>
    fun arg_0__ arg_1__ =>
      match arg_0__, arg_1__ with
      | f, Pure x => Data.Functor.op_zlzdzg__ Pure (f x)
      | f, Other y => Data.Functor.op_zlzdzg__ Other (Data.Traversable.traverse f y)
      end.
...
#[global] Definition unLift {f : Type -> Type} {a : Type} `{GHC.Base.Applicative
  f}
   : Lift f a -> f a :=
  fun arg_0__ =>
    match arg_0__ with
...
#[local] Definition Applicative__Lift_op_zlztzg__ {inst_f : Type -> Type}
  ...
  fun {a : Type} {b : Type} =>
    fun arg_0__ arg_1__ =>
      match arg_0__, arg_1__ with
      | Pure f, ax => Data.Functor.op_zlzdzg__ f ax
      | Other f, ax => Other (f GHC.Base.<*> unLift ax)
      end.
...
#[local] Definition Applicative__Lift_op_ztzg__ {inst_f : Type -> Type}
  ...
  fun {a : Type} {b : Type} =>
    fun a1 a2 =>
      Applicative__Lift_op_zlztzg__ (GHC.Base.op_zlzd__ GHC.Base.id a1) a2.
...
(* Skipping all instances of class `Data.Foldable1.Foldable1', including
   `Control.Applicative.Lift.Foldable1__Lift' *)

#[global] Definition mapLift {f : Type -> Type} {a : Type} {g : Type -> Type}
...
#[global] Definition elimLift {a : Type} {r : Type} {f : Type -> Type}
...
#[global] Definition runErrors {e : Type} {a : Type}
...
#[global] Definition failure {e : Type} {a : Type} : e -> Errors e a :=
  fun e => Other (Data.Functor.Constant.Mk_Constant e).

#[global] Definition eitherToErrors {e : Type} {a : Type}
...
(* External variables:
     ...
     Data.Functor.Classes.liftEq__ Data.Functor.Constant.Constant
