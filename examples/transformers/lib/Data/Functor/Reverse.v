...
#[global] Definition getReverse {k : Type} {f : k -> Type} {a : k} (arg_0__
    : Reverse f a) :=
...
#[local] Definition Eq___Reverse_op_zeze__ {inst_f : Type -> Type} {inst_a
   : Type} `{Data.Functor.Classes.Eq1 inst_f} `{GHC.Base.Eq_ inst_a}
   : Reverse inst_f inst_a -> Reverse inst_f inst_a -> bool :=
  Data.Functor.Classes.eq1.

#[local] Definition Eq___Reverse_op_zsze__ {inst_f : Type -> Type} {inst_a
   : Type} `{Data.Functor.Classes.Eq1 inst_f} `{GHC.Base.Eq_ inst_a}
   : Reverse inst_f inst_a -> Reverse inst_f inst_a -> bool :=
...
#[local] Definition Ord__Reverse_op_zlze__ {inst_f : Type -> Type} {inst_a
...
#[local] Definition Ord__Reverse_op_zgze__ {inst_f : Type -> Type} {inst_a
   : Type} `{Data.Functor.Classes.Ord1 inst_f} `{GHC.Base.Ord inst_a}
   : Reverse inst_f inst_a -> Reverse inst_f inst_a -> bool :=
  fun x y => Ord__Reverse_compare x y GHC.Base./= Lt.
...
#[local] Definition Applicative__Reverse_op_ztzg__ {inst_f : Type -> Type}
  ...
  fun {a : Type} {b : Type} =>
    fun a1 a2 =>
      Applicative__Reverse_op_zlztzg__ (GHC.Base.op_zlzd__ GHC.Base.id a1) a2.
...
#[local] Definition Foldable__Reverse_foldl' {inst_f : Type -> Type}
  ...
  fun {b : Type} {a : Type} =>
    fun f z0 =>
      fun xs =>
        Foldable__Reverse_foldr (fun arg_0__ arg_1__ =>
                                   match arg_0__, arg_1__ with
...
#[local] Definition Foldable__Reverse_foldMap' {inst_f : Type -> Type}
  ...
  fun {m : Type} {a : Type} `{GHC.Base.Monoid m} =>
    fun f =>
      Foldable__Reverse_foldl' (fun acc a => acc GHC.Base.<<>> f a) GHC.Base.mempty.
...
#[local] Definition Foldable__Reverse_foldr' {inst_f : Type -> Type}
  ...
  fun {a : Type} {b : Type} =>
    fun f z0 =>
      fun xs =>
        Foldable__Reverse_foldl (fun arg_0__ arg_1__ =>
                                   match arg_0__, arg_1__ with
...
(* Skipping all instances of class `Data.Foldable1.Foldable1', including
   `Data.Functor.Reverse.Foldable1__Reverse' *)
...
(* Skipping all instances of class `Data.Functor.Contravariant.Contravariant',
   including `Data.Functor.Reverse.Contravariant__Reverse' *)
...
(* External variables:
     ...
     GHC.Base.id GHC.Base.liftA2__ GHC.Base.max__ GHC.Base.mempty GHC.Base.min__
     ...
     GHC.Base.return___ GHC.Num.Int GHC.Num.Num GHC.Prim.seq
*)
