...
#[global] Instance Default__Termination {r} : HsToCoq.Err.Default (Termination r) :=
...
#[global] Instance Default__StrictSig : HsToCoq.Err.Default StrictSig :=
  HsToCoq.Err.Build_Default _ (Mk_StrictSig HsToCoq.Err.default).

#[global] Instance Default__JointDmd `{HsToCoq.Err.Default a} `{HsToCoq.Err.Default b} : HsToCoq.Err.Default (JointDmd a b) :=
  HsToCoq.Err.Build_Default _ (JD HsToCoq.Err.default HsToCoq.Err.default).

#[global] Instance Default__Str {s} : HsToCoq.Err.Default (Str s) :=
  HsToCoq.Err.Build_Default _ Lazy.
#[global] Instance Default__Use {s} : HsToCoq.Err.Default (Use s) :=
...
#[global] Instance Default__Var : HsToCoq.Err.Default Var := HsToCoq.Err.Build_Default _ (Mk_Id HsToCoq.Err.default HsToCoq.Err.default HsToCoq.Err.default HsToCoq.Err.default HsToCoq.Err.default HsToCoq.Err.default).


#[global] Instance Default__DataCon : HsToCoq.Err.Default DataCon :=
