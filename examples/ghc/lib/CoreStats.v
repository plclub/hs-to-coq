...
#[global] Definition cs_jb (arg_0__ : CoreStats) :=
  let 'CS _ _ _ _ cs_jb := arg_0__ in
  cs_jb.

#[global] Definition cs_tm (arg_0__ : CoreStats) :=
  let 'CS cs_tm _ _ _ _ := arg_0__ in
  cs_tm.

#[global] Definition cs_ty (arg_0__ : CoreStats) :=
  let 'CS _ cs_ty _ _ _ := arg_0__ in
  cs_ty.

#[global] Definition cs_vb (arg_0__ : CoreStats) :=
...
#[global] Definition plusCS : CoreStats -> CoreStats -> CoreStats :=
  fun arg_0__ arg_1__ =>
...
#[global] Definition coreBindsStats : list CoreBind -> CoreStats :=
...
#[global] Definition bindingStats
...
#[global] Definition bndrsSize : list Var -> nat :=
  sum ∘ map bndrSize.
...
#[global] Definition coreBindsSize : list CoreBind -> nat :=
