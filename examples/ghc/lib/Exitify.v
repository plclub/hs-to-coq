...
#[global] Definition mkExitJoinId
   : Core.InScopeSet ->
...
(* External variables:
     ...
     Core.Rec Core.Var Core.VarSet Core.anyVarSet Core.bindersOf Core.collectArgs
     ...
     Id.setIdInfo Outputable.JoinPoint Util.mapSnd
*)
