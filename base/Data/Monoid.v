...
Inductive Ap f a : Type := | Ap (getAp : f a) : Ap f a.
...
Definition getAp {f} {a} (arg_0__ : Ap f a) :=
  let 'Ap getAp := arg_0__ in
  getAp.
...
Local Definition Semigroup__Ap_op_zlzlzgzg__ {inst_f : Type -> Type} {inst_a
  ...
  fun arg_0__ arg_1__ =>
    match arg_0__, arg_1__ with
    | Ap x, Ap y => Ap (GHC.Base.liftA2 _GHC.Base.<<>>_ x y)
    end.
...
Local Definition Monoid__Ap_mempty {inst_f : Type -> Type} {inst_a : Type}
  `{GHC.Base.Applicative inst_f} `{GHC.Base.Monoid inst_a}
   : Ap inst_f inst_a :=
  Ap (GHC.Base.pure GHC.Base.mempty).
