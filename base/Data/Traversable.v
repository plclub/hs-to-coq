...
Local Definition Traversable__Ap_traverse {inst_f : Type -> Type} `{(Traversable
   inst_f)}
   : forall {f : Type -> Type},
     forall {a : Type},
     forall {b : Type},
  ...
  fun {f : Type -> Type} {a : Type} {b : Type} `{GHC.Base.Applicative f} =>
    fun arg_0__ arg_1__ =>
      match arg_0__, arg_1__ with
      | f, Data.Monoid.Ap x => Data.Monoid.Ap Data.Functor.<$> traverse f x
      end.
...
Local Definition Traversable__Ap_sequence {inst_f : Type -> Type} `{(Traversable
   inst_f)}
   : forall {m : Type -> Type},
     forall {a : Type},
     forall `{GHC.Base.Monad m},
...
(* External variables:
     ...
     Data.Ord.Down Data.Ord.Mk_Down Data.Proxy.Mk_Proxy Data.Proxy.Proxy
